...
class Tag(MethodView):
    ...
    @blp.alt_response(
        400,
        description="Returned if the tag is assigned to one or more items. In yhis case, the tag is not deleted"
    )
...
class LinktagsToItem(MethodView):
    ...
    def delete(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An error occurred while removing tag")
